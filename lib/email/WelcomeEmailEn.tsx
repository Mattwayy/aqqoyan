...
export function WelcomeEmailEn({ name, surname }: Props) {
  return (
    <Html lang="en" dir="ltr">
      ...
      <Preview>You are registered for Islamic Finance and Business Forum 2026</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Section style={infoBox}>
              <Text style={infoRow}><span style={infoLabel}>📅 Date</span><span style={infoValue}>May 21, 2026</span></Text>
              <Hr style={infoHr} />
              <Text style={infoRow}><span style={infoLabel}>🕐 Time</span><span style={infoValue}>09:00–17:00</span></Text>
              <Hr style={infoHr} />
              <Text style={infoRow}><span style={infoLabel}>📍 Venue</span><span style={infoValue}>Astana, Astana International Financial Centre (AIFC), Mangilik El Avenue, Building 55/18, Block C3.4</span></Text>
            </Section>
            <Text style={paragraph}>
            ...
            <Section style={ctaSection}>
              <Link href="https://ifbforum.kz/profile" style={ctaButton}>Go to my account</Link>
            </Section>
            <Text style={paragraph}>
              A detailed program and logistical information will be sent to your email address as the event approaches.
              To stay updated on the latest news and announcements, we recommend following our official social media pages:
            </Text>
            ...
            <Text style={paragraph}>We look forward to welcoming you to the Islamic Finance and Business Forum 2026.</Text>
            <Text style={note}>
              <strong>Important Travel Note:</strong> Please be advised that scheduled maintenance work will be conducted on the runway at Astana Airport from April 15 to May 31, 2026. During this period, the runway will be temporarily closed daily from 10:00 AM to 6:00 PM local time. We kindly ask you to take potential flight schedule changes into account and plan your travel itinerary accordingly.
            </Text>
          </Section>
          ...
          <Section style={footer}>
            ...
            <Text style={footerLinks}>
              ...
              {' · '}
              <Link href="https://ifbforum.kz/terms" style={link}>Terms of Service</Link>
              {' · '}
              <Link href="https://ifbforum.kz/privacy" style={link}>Privacy Policy</Link>
            </Text>
            <Text style={footerMuted}>This is an automated message. Please do not reply to this email.</Text>
          </Section>
