...
export function WelcomeEmailRu({ name, surname }: Props) {
  return (
    <Html lang="ru" dir="ltr">
      ...
      <Preview>Вы зарегистрированы на Islamic Finance and Business Forum 2026</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Section style={infoBox}>
              <Text style={infoRow}><span style={infoLabel}>📅 Дата</span><span style={infoValue}>21 мая 2026 года</span></Text>
              <Hr style={infoHr} />
              <Text style={infoRow}><span style={infoLabel}>🕐 Время</span><span style={infoValue}>09:00–17:00</span></Text>
              <Hr style={infoHr} />
              <Text style={infoRow}><span style={infoLabel}>📍 Место</span><span style={infoValue}>г. Астана, Международный финансовый центр «Астана» (МФЦА), проспект Мангилик Ел, здание 55/18, блок С3.4</span></Text>
            </Section>
            <Text style={paragraph}>
            ...
            <Section style={ctaSection}>
              <Link href="https://ifbforum.kz/profile" style={ctaButton}>Перейти в личный кабинет</Link>
            </Section>
            <Text style={paragraph}>
              Подробная программа форума и логистические детали будут направлены на ваш электронный адрес по мере приближения даты форума.
              Рекомендуем также подписаться на наши официальные страницы в социальных сетях, чтобы следить за новостями и анонсами:
            </Text>
            ...
            <Text style={paragraph}>Будем рады приветствовать Вас на Islamic Finance and Business Forum 2026.</Text>
            <Text style={note}>
              <strong>Примечание:</strong> в период с 15 апреля по 31 мая 2026 года в аэропорту Астаны на взлетно-посадочной полосе проводятся плановые ремонтные работы. В связи с этим в указанные даты полоса будет временно закрыта ежедневно с 10:00 до 18:00 по местному времени. Просим учитывать возможные изменения в расписании рейсов и заранее планировать маршрут.
            </Text>
          </Section>
          ...
          <Section style={footer}>
            ...
            <Text style={footerLinks}>
              ...
              {' · '}
              <Link href="https://ifbforum.kz/terms" style={link}>Условия использования</Link>
              {' · '}
              <Link href="https://ifbforum.kz/privacy" style={link}>Конфиденциальность</Link>
            </Text>
            <Text style={footerMuted}>Это письмо отправлено автоматически. Пожалуйста, не отвечайте на него.</Text>
          </Section>
